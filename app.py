...
# Utiliser une variable d'environnement pour définir le chemin de la base de données
DATABASE = os.getenv('DATABASE_PATH', os.path.join(application_path, 'data', 'saisie.db'))
